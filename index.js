...
/******/ 	var hotCurrentHash = "c0d084f812d184e7cc12"; // eslint-disable-line no-unused-vars
...
var Calendar = function (_DateMethod) {
    ...
    _createClass(Calendar, [{
        ...
        value: function getContentHtml(options) {
            ...
            var daysHtml = '';
            var now = new Date();
            var currentDay = this.options.currentDay;
            var dateObj = this.getDateObj(currentDay ? this.toDate(currentDay) : now);
